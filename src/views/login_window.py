...
class LoginWindow(QMainWindow):
    ...
    def hide_unnecessary_elements(self):
        ...
        self.ui.content.setGeometry(0, 0, 2040, 1290)

        # 创建一个新的主内容区域
        self.main_content = QFrame(self.ui.content)
        self.main_content.setGeometry(0, 0, 2040, 1200)
        self.main_content.setObjectName("main_content")
        self.main_content.setStyleSheet("""
            QFrame#main_content {
                background-image: url(:/images/images/background_PhotoMax.png);
    ...
    def setup_login_area(self):
        ...
        x_pos = 2040 - container_width - 200  # 距离右边 像素
    ...
    def create_login_page(self):
        ...
        """)
        # 增加表单高度从650到700
        login_form.setFixedSize(550, 700)  # 增加高度以适应更大的标题

        form_layout = QVBoxLayout(login_form)
        form_layout.setSpacing(15)  # 适当增加间距

        # 标题 - 增加高度并确保可见
        title = QLabel("用户登录")
        title_font = QFont()
        title_font.setFamily("Microsoft YaHei UI")
        title_font.setPointSize(20)  # 进一步增大标题字体
        ...
        title.setFixedHeight(80)  # 增加标题高度到80
        ...
        """)
        login_button.setMinimumHeight(80)
        ...
        register_label.setStyleSheet(
            "color: white; font-size: 12pt; font-family: 'Microsoft YaHei UI'; background-color: transparent;")
        register_label.setFixedHeight(35)
        ...
        form_layout.addSpacing(20)  # 减少间距从30到20
        form_layout.addWidget(self.username_input)
        form_layout.addSpacing(20)  # 减少间距从30到20
        form_layout.addWidget(self.password_input)
        form_layout.addSpacing(20)  # 减少间距从30到20
        form_layout.addWidget(login_button)
        form_layout.addSpacing(30)  # 减少间距从40到30
    ...
    def create_register_page(self):
        ...
        """)
        # 增加表单高度从650到750
        register_form.setFixedSize(550, 700)  # 增加高度以适应更大的标题
        ...
        """)
        self.reg_username_input.setMinimumHeight(80)
        ...
        """)
        self.reg_password_input.setMinimumHeight(80)
        ...
        """)
        self.reg_confirm_password_input.setMinimumHeight(80)
        ...
        """)
        register_button.setMinimumHeight(80)
